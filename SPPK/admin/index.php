...
<body>
  <div class="sidebar">
    ...
    <div class="has-dropdown">
      ...
      <div class="dropdown-menu">
        <ul>
          <li><a href="crud/c-siswa.php">Siswa</a></li>
          <li><a href="crud/c-kelas.php">Kelas</a></li>
          <li><a href="crud/c-spp.php">SPP</a></li>
          <li><a href="crud/c-petugas">Petugas</a></li>
        </ul>
      </div>
    </div>
    <br /><br /><br /><br />
    <a href="../login/logout.php" style="color:white;background:red; border-radius:3px; padding:5px; width:70px; text-align:center; margin-left:10px;">Logout</a><br><br>
  </div>
